...
| -------------- | ------------------ | ---------------------- | ------ | ----- | ---- | ------------------ |
| **Repulsion**  | Charge Strength    | `chargeStrength`       | -12000 | -5    | 10   | -350 / -600 (auto) |
|                | Charge Range       | `distanceMax`          | 10     | 15000 | 50   | 600                |
...
|                | Layer Exponent     | `layerExponent`        | 0.1    | 3.0   | 0.1  | 1.0                |
| **Centering**  | Center Strength    | `centerStrength`       | 0.0    | 0.5   | 0.01 | 0.03               |
...
- **Accordion component**: The panel now uses the shared `GlassAccordion.svelte` component for its collapsible toggle/chevron pattern instead of an inline implementation

---

## Persistence (localStorage)

- **Key**: `"bacchus-physics"` — stores a JSON object of only the user-overridden values (sparse, not all 12)

...
This folder contains the design specifications for Project Bacchus.
...
| [CLI.md](CLI.md)                         | CLI tool design for `@bacchus/cli`                                          |
| [MCP.md](MCP.md)                         | MCP server design — tool reference, I/O layer, error handling, architecture |
| [VSCodeExtension.md](VSCodeExtension.md) | VS Code extension design — MCP integration, activation, build, testing      |
| [UserGuide.md](UserGuide.md)             | End-user walkthrough with annotated screenshots                             |
